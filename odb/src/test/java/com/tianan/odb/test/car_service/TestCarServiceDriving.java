...
import com.tianan.odb.android_pages.carserver.CarServiceDrivingActivityPages;
import com.tianan.odb.configuration_device.ConfigurationAndroid;
import com.tianan.odb.public_infunction.login_success;
import org.testng.annotations.BeforeClass;
import org.testng.annotations.AfterClass;
/**
 * 本节是代驾服务，输入手机号，获取验证码，暂不写流程
 * @author 张豆豆
 *
 */
public class TestCarServiceDriving {
  private static MyLogger logger = MyLogger.getLogger(TestCarServiceDriving.class);
  ...
  private CarServiceDrivingActivityPages driver = new CarServiceDrivingActivityPages();
  
  @Test
  public void odbTestgetDiscount() {
	//TODO
	driver.odbCarServiceDrivingPhoneNum().sendKeys("");
  ...
  public void beforeClass() {
	...
	carservice.odbCarServiceDriving().click();
	HolmosBaseUtils.sleep(5000);
	logger.info("打开代驾服务页面");
  }
